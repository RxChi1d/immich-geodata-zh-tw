...
def create_release(output_dir):
    ...
    # 需要複製的檔案
    files_to_copy = {
        "geoname_data/ne_10m_admin_0_countries.geojson": os.path.join(geodata_dir, "ne_10m_admin_0_countries.geojson"),
        "output/admin1CodesASCII_translated.txt": os.path.join(geodata_dir, "admin1CodesASCII.txt"),
        "output/admin2Codes_translated.txt": os.path.join(geodata_dir, "admin2Codes.txt"),
    ...
    shutil.copytree("i18n-iso-countries", os.path.join(release_dir, "i18n-iso-countries"))
